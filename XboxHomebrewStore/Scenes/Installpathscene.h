...
typedef void (*InstallPathConfirmedCb)(const std::string& chosenPath, void* userData);
...
private:
    ...
    void RenderHeader();
    void RenderFooter();
    void DrawFooterControl(float& x, float footerY,
    ...
    enum KbPurpose { KbNone, KbCreate, KbRename };
