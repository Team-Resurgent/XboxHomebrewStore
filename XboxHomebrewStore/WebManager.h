...
public:
  ...
  static bool TryGetFileSize(const std::string &url, uint64_t &outSize);
  ...
  static bool TryGetApps(AppsResponse &result, int32_t offset, int32_t count, const std::string category = "", const std::string name = "", volatile bool *pCancelRequested = NULL);
