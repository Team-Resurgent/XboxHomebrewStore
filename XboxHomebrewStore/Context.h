...
/** Logical size = design resolution (e.g. 640x480). Actual = backbuffer size.
 * Scale maps logical -> actual. */
class Context {
public:
  ...
  static void SetSafeAreaInsets(float left, float top, float right,
      float bottom);
